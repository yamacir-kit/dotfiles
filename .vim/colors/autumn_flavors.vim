...
hi Boolean         ctermfg=31  ctermbg=234 cterm=bold
...
"  Statement
" -------------------------------------------------------------
hi Statement       ctermfg=161 ctermbg=234 cterm=none " goto break return continue asm
hi Conditional     ctermfg=161 ctermbg=234 cterm=none " if else switch
hi Repeat          ctermfg=161 ctermbg=234 cterm=none " while for do
hi Label           ctermfg=161 ctermbg=234 cterm=bold " case default
hi Tag             ctermfg=161 ctermbg=234 cterm=bold
